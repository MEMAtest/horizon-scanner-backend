                  ...
                  <div className="flex items-start space-x-4">
                    <div className="flex-shrink-0">
                      <div className={`p-2 rounded-full ${
                        deadline.urgency === 'Overdue' ? 'bg-red-100' :
                        deadline.urgency === 'This Week' ? 'bg-orange-100' :
                        deadline.urgency === 'This Month' ? 'bg-yellow-100' :
                        'bg-blue-100'
                      }`}>
                        <TypeIcon className={`w-5 h-5 ${
                          deadline.urgency === 'Overdue' ? 'text-red-600' :
                          deadline.urgency === 'This Week' ? 'text-orange-600' :
                          deadline.urgency === 'This Month' ? 'text-yellow-600' :
                          'text-blue-600'
                        }`} />
                      </div>
                    </div>
