...
// Web scraping service for regulatory authorities
...
// Generic scraper for other regulatory bodies
const scrapeGeneric = async (config) => {
    const { name, url, selectors, dateSelectors } = config;
...
// Utility function to test selectors on a page
